performance.mark("js-parse-end:63211-fb5d39ac620e02bb.js");
export const __rspack_esm_id = 63211;
export const __rspack_esm_ids = [63211];
export const __webpack_modules__ = {
    623389(t, e, i) {
        ...
        var a = ["aria-hidden", "aria-label", "aria-labelledby", "tabIndex", "className", "fill", "size", "verticalAlign", "id", "title", "style"],
            o = {
                small: 16,
                medium: 32,
                large: 64
        ...
        function u(t, e, i, u, c) {
            var h, l, d = t["aria-hidden"],
                f = t["aria-label"],
                p = t["aria-labelledby"],
                y = t.tabIndex,
                m = t.className,
                ...
                q = function(t, e) {
                    ...
                    if (Object.getOwnPropertySymbols) {
                        ...
                        for (s = 0; s < n.length; s++) i = n[s], -1 === e.indexOf(i) && ({}).propertyIsEnumerable.call(t, i) && (r[i] = t[i])
                    }
                    return r
                }(t, a),
                S = o[g] || g,
                j = (h = c, l = S, h.map(function(t) {
            ...
            return s.createElement("svg", r({
                ...
                "aria-hidden": A,
                tabIndex: y,
                focusable: y >= 0 ? "true" : "false",
                "aria-label": f,
                "aria-labelledby": p,
                className: "".concat(i, " ").concat(void 0 === m ? "" : m).trim(),
                role: D && "true" !== A ? "img" : void 0,
                viewBox: "0 0 ".concat(Q, " ").concat(j),
                width: F,
                height: S,
                fill: void 0 === v ? "currentColor" : v,
                id: w,
                ...
                style: function(t) {
                    ...
                    verticalAlign: void 0 === O ? "text-bottom" : O
                }, P)
            }), C ? s.createElement("title", null, C) : null, E)
        }
        i.d(e, {
            r: () => u
        })
                    ...
                    let r = e.options,
                        ...
                        d = async () => {
                            ...
                            if (o && u.length) {
                                ...
                                let e = t ? ? u.length;
                                do {
                                    let t = 0 === l ? c[0] ? ? r.initialPageParam : n(r, h);
                                    if (l > 0 && null == t) break;
                                    h = await f(h, t), l++
                                } while (l < e)
                            }
    ...
    236158(t, e, i) {
        var s = i(226261),
            ...
            a = class extends r.k {#
                ...
                a;
                constructor(t) {
                    super(), this.#s = t.client, this.mutationId = t.mutationId, this.#n = t.mutationCache, this.#r = [], this.state = t.state || o(), this.setOptions(t.options), this.scheduleGc()
                }
                setOptions(t) {
                ...
                addObserver(t) {
                    this.#r.includes(t) || (this.#r.push(t), this.clearGcTimeout(), this.#n.notify({
                        type: "observerAdded",
                        mutation: this,
                        observer: t
                    }))
                ...
                removeObserver(t) {
                    this.#r = this.#r.filter(e => e !== t), this.scheduleGc(), this.#n.notify({
                ...
                optionalRemove() {
                    this.#r.length || ("pending" === this.state.status ? this.scheduleGc() : this.#n.remove(this))
                }
                continue () {
                    ...
                    try {
                        if (s) e();
                            ...
                            this.#o({
                                ...
                                variables: t,
                                isPaused: r
                            }), await this.#n.config.onMutate ? .(t, this, i);
                        ...
                        let n = await this.#a.start();
                        return await this.#n.config.onSuccess ? .(n, t, this.state.context, this, i), await this.options.onSuccess ? .(n, t, this.state.context, i), await this.#n.config.onSettled ? .(n, null, this.state.variables, this.state.context, this, i), await this.options.onSettled ? .(n, null, t, this.state.context, i), this.#o({
                            type: "success",
                            data: n
                        }), n
                    } catch (e) {
                        try {
                            await this.#n.config.onError ? .(e, t, this.state.context, this, i)
                        } catch (t) {
                            Promise.reject(t)
                        }
                        try {
                        ...
                        try {
                            await this.#n.config.onSettled ? .(void 0, e, this.state.variables, this.state.context, this, i)
                        } catch (t) {
                            Promise.reject(t)
                        }
                        try {
    ...
    457678(t, e, i) {
        var s = i(226261),
            ...
            o = class extends a.Q {
                constructor(t = {}) {
                    super(), this.config = t, this.#u = new Set, this.#c = new Map, this.#h = 0
                }#
                u;#
                c;#
                h;
                ...
                runNext(t) {
                    ...
                    if ("string" != typeof e) return Promise.resolve(); {
                        let i = this.#c.get(e) ? .find(e => e !== t && e.state.isPaused);
                ...
                resumePausedMutations() {
                    ...
                    return s.jG.batch(() => Promise.all(t.map(t => t.continue().catch(n.lQ))))
                }
            };
    ...
    696035(t, e, i) {
        var s = i(266500),
            ...
            n = new class extends s.Q {#
                ...
                setOnline(t) {
                    this.#l !== t && (this.#l = t, this.listeners.forEach(e => {
                        e(t)
                    }))
                }
                isOnline() {
    ...
    379757(t, e, i) {
        var s = i(924880),
            ...
            o = class extends a.k {#
                ...
                m;
                constructor(t) {
                    super(), this.#m = !1, this.#y = t.defaultOptions, this.setOptions(t.options), this.observers = [], this.#s = t.client, this.#p = this.#s.getQueryCache(), this.queryKey = t.queryKey, this.queryHash = t.queryHash, this.#d = h(this.options), this.state = t.state ? ? this.#d, this.scheduleGc()
                }
                get meta() {
                    return this.options.meta
                }
                ...
                cancel(t) {
                    ...
                    return this.#a ? .cancel(t), e ? e.then(s.lQ).catch(s.lQ) : Promise.resolve()
                }
                destroy() {
                ...
                addObserver(t) {
                    this.observers.includes(t) || (this.observers.push(t), this.clearGcTimeout(), this.#p.notify({
                        type: "observerAdded",
                        query: this,
                        observer: t
                    }))
                ...
                removeObserver(t) {
                    this.observers.includes(t) && (this.observers = this.observers.filter(e => e !== t), this.observers.length || (this.#a && (this.#m ? this.#a.cancel({
                        revert: !0
                    }) : this.#a.cancelRetry()), this.scheduleGc()), this.#p.notify({
                        type: "observerRemoved",
                        query: this,
                        observer: t
                    }))
                ...
                async fetch(t, e) {
                    ...
                    let r = new AbortController,
                        ...
                        o = () => {
                            let t, i = (0, s.ZM)(this.options, e),
                                r = (a(t = {
                                    client: this.#s,
                                    queryKey: this.queryKey,
                                    meta: this.meta
                                }), t);
                            return (this.#m = !1, this.options.persister) ? this.options.persister(i, r, this) : i(r)
                        },
                        u = (a(i = {
                            fetchOptions: e,
                    ...
                    this.options.behavior ? .onFetch(u, this), this.#f = this.state, ("idle" === this.state.fetchStatus || this.state.fetchMeta !== u.fetchOptions ? .meta) && this.#o({
                        type: "fetch",
                        ...
                        fn: u.fetchFn,
                        onCancel: t => {
                            t instanceof n.cc && t.revert && this.setState({ ...this.#f,
                                fetchStatus: "idle"
                            }), r.abort()
                        },
                        onFail: (t, e) => {
                    ...
                    try {
                        ...
                        return this.setData(t), this.#p.config.onSuccess ? .(t, this), this.#p.config.onSettled ? .(t, this.state.error, this), t
                    } catch (t) {
                        ...
                        throw this.#o({
                            type: "error",
                            error: t
                        }), this.#p.config.onError ? .(t, this), this.#p.config.onSettled ? .(this.state.data, t, this), t
                    } finally {
                        this.scheduleGc()
                    }
                }#
                o(t) {
                    let e = e => {
                        switch (t.type) {
                            ...
                            case "success":
                                ...
                                return this.#f = t.manual ? i : void 0, i;
                            case "error":
                                let s = t.error;
                                return { ...e,
                                    error: s,
                    ...
                    this.state = e(this.state), r.jG.batch(() => {
    ...
    102471(t, e, i) {
        var s = i(924880),
            ...
            o = class extends a.Q {
                ...
                add(t) {
                    this.#v.has(t.queryHash) || (this.#v.set(t.queryHash, t), this.notify({
                        type: "added",
                        query: t
                    }))
                }
                remove(t) {
                    ...
                    e && (t.destroy(), e === t && this.#v.delete(t.queryHash), this.notify({
                        type: "removed",
                        query: t
                    }))
                }
                ...
                find(t) {
                    ...
                    return this.getAll().find(t => (0, s.MK)(e, t))
                }
                findAll(t = {}) {
                    let e = this.getAll();
                    return Object.keys(t).length > 0 ? e.filter(e => (0, s.MK)(t, e)) : e
                }
                notify(t) {
                    n.jG.batch(() => {
                        this.listeners.forEach(e => {
    ...
    865490(t, e, i) {
        var s = i(924880),
            ...
            h = class {#
                ...
                P;
                constructor(t = {}) {
                    this.#b = t.queryCache || new r.$, this.#n = t.mutationCache || new n.q, this.#y = t.defaultOptions || {}, this.#g = new Map, this.#O = new Map, this.#w = 0
                }
                mount() {
                    this.#w++, 1 === this.#w && (this.#C = a.m.subscribe(async t => {
                        t && (await this.resumePausedMutations(), this.#b.onFocus())
                    }), this.#P = o.t.subscribe(async t => {
                        t && (await this.resumePausedMutations(), this.#b.onOnline())
                    }))
                }
                unmount() {
                    this.#w--, 0 === this.#w && (this.#C ? .(), this.#C = void 0, this.#P ? .(), this.#P = void 0)
                }
                isFetching(t) {
                    return this.#b.findAll({ ...t,
                        fetchStatus: "fetching"
                    }).length
                }
                isMutating(t) {
                ...
                ensureQueryData(t) {
                    let e = this.defaultQueryOptions(t),
                        i = this.#b.build(this, e),
                        r = i.state.data;
                    return void 0 === r ? this.fetchQuery(t) : (t.revalidateIfStale && i.isStaleByTime((0, s.d2)(e.staleTime, i)) && this.prefetchQuery(e), Promise.resolve(r))
                }
                getQueriesData(t) {
                    return this.#b.findAll(t).map(({
                        queryKey: t,
                        state: e
                    }) => [t, e.data])
                }
                setQueryData(t, e, i) {
                    let r = this.defaultQueryOptions({
                        ...
                        n = this.#b.get(r.queryHash),
                        a = n ? .state.data,
                        o = (0, s.Zw)(e, a);
                    if (void 0 !== o) return this.#b.build(this, r).setData(o, { ...i,
                        manual: !0
                    })
                }
                setQueriesData(t, e, i) {
                    return u.jG.batch(() => this.#b.findAll(t).map(({
                        queryKey: t
                ...
                resetQueries(t, e) {
                    let i = this.#b;
                    return u.jG.batch(() => (i.findAll(t).forEach(t => {
                        t.reset()
                    }), this.refetchQueries({
                        type: "active",
                        ...t
                ...
                cancelQueries(t, e = {}) {
                    ...
                    return Promise.all(u.jG.batch(() => this.#b.findAll(t).map(t => t.cancel(i)))).then(s.lQ).catch(s.lQ)
                }
                invalidateQueries(t, e = {}) {
                    return u.jG.batch(() => (this.#b.findAll(t).forEach(t => {
                        t.invalidate()
                ...
                refetchQueries(t, e = {}) {
                    ...
                    return Promise.all(u.jG.batch(() => this.#b.findAll(t).filter(t => !t.isDisabled() && !t.isStatic()).map(t => {
                        let e = t.fetch(void 0, i);
                        return i.throwOnError || (e = e.catch(s.lQ)), "paused" === t.state.fetchStatus ? Promise.resolve() : e
                    }))).then(s.lQ)
                }
                fetchQuery(t) {
                    let e = this.defaultQueryOptions(t);
                    void 0 === e.retry && (e.retry = !1);
                    let i = this.#b.build(this, e);
                    return i.isStaleByTime((0, s.d2)(e.staleTime, i)) ? i.fetch(e) : Promise.resolve(i.state.data)
                }
                prefetchQuery(t) {
                    return this.fetchQuery(t).then(s.lQ).catch(s.lQ)
                }
                fetchInfiniteQuery(t) {
                    return t.behavior = (0, c.PL)(t.pages), this.fetchQuery(t)
                }
                prefetchInfiniteQuery(t) {
                    return this.fetchInfiniteQuery(t).then(s.lQ).catch(s.lQ)
                }
                ensureInfiniteQueryData(t) {
                    return t.behavior = (0, c.PL)(t.pages), this.ensureQueryData(t)
                }
                resumePausedMutations() {
                    return o.t.isOnline() ? this.#n.resumePausedMutations() : Promise.resolve()
                }
                getQueryCache() {
                    return this.#b
                }
                ...
                getQueryDefaults(t) {
                    let e = [...this.#g.values()],
                        i = {};
                    return e.forEach(e => {
                        (0, s.Cp)(t, e.queryKey) && Object.assign(i, e.defaultOptions)
                    }), i
                }
                ...
                getMutationDefaults(t) {
                    let e = [...this.#O.values()],
                        i = {};
                    return e.forEach(e => {
                        (0, s.Cp)(t, e.mutationKey) && Object.assign(i, e.defaultOptions)
                    }), i
                }
                defaultQueryOptions(t) {
                    if (t._defaulted) return t;
                    let e = { ...this.#y.queries,
                        ...this.getQueryDefaults(t.queryKey),
                        ...t,
                        _defaulted: !0
                    };
                    return e.queryHash || (e.queryHash = (0, s.F$)(e.queryKey, e)), void 0 === e.refetchOnReconnect && (e.refetchOnReconnect = "always" !== e.networkMode), void 0 === e.throwOnError && (e.throwOnError = !!e.suspense), !e.networkMode && e.persister && (e.networkMode = "offlineFirst"), e.queryFn === s.hT && (e.enabled = !1), e
                }
                defaultMutationOptions(t) {
                    return t ? ._defaulted ? t : { ...this.#y.mutations,
    ...
    71692(t, e, i) {
        var s = i(252775),
            ...
            n = class {#
                ...
                scheduleGc() {
                    this.clearGcTimeout(), (0, r.gn)(this.gcTime) && (this.#q = s.zs.setTimeout(() => {
                        this.optionalRemove()
                    }, this.gcTime))
                }
                updateGcTime(t) {
                ...
                clearGcTimeout() {
                    this.#q && (s.zs.clearTimeout(this.#q), this.#q = void 0)
                }
            };
        i.d(e, {
            k: () => n
    ...
    758904(t, e, i) {
        ...
        function l(t) {
            let e, i = !1,
                h = 0,
                l = (0, n.T)(),
                d = () => s.m.isFocused() && ("always" === t.networkMode || r.t.isOnline()) && t.canRun(),
                ...
                v = () => {
                    ...
                    Promise.resolve(e).then(p).catch(e => {
                        ...
                        i || !u ? y(e) : (h++, t.onFail ? .(h, e), (0, a.yy)(n).then(() => d() ? void 0 : m()).then(() => {
                            i ? y(e) : v()
                        }))
                    })
                };
    ...
    594658(t, e, i) {
        ...
        function n(t) {
            let e;
            if (t.then(t => (e = t, t), s.lQ) ? .catch(s.lQ), void 0 !== e) return {
                data: e
            }
        }
        i.d(e, {
    ...
    924880(t, e, i) {
        ...
        function p(t) {
            return JSON.stringify(t, (t, e) => O(e) ? Object.keys(e).sort().reduce((t, i) => (t[i] = e[i], t), {}) : e)
        }
        ...
        function P(t, e, i) {
            return "function" == typeof i.structuralSharing ? i.structuralSharing(t, e) : !1 !== i.structuralSharing ? v(t, e) : e
        }
        ...
        function D(t, e, i) {
            ...
            return Object.defineProperty(t, "signal", {
                enumerable: !0,
                get: () => (s ? ? = e(), r || (r = !0, s.aborted ? i() : s.addEventListener("abort", i, {
                    once: !0
                })), s)
            }), t
        }
...
//# sourceMappingURL=63211-fb5d39ac620e02bb-dc622e32de51045c.js.map