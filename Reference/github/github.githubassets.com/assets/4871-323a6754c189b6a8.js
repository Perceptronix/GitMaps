performance.mark("js-parse-end:4871-323a6754c189b6a8.js");
export const __rspack_esm_id = 4871;
export const __rspack_esm_ids = [4871];
export const __webpack_modules__ = {
    580676(e, i, t) {
        ...
        t.d(i, {
            ...
            J: {
                entries: e => Object.entries(e).filter(e => n.dx.is(e[0]) && void 0 !== e[1]),
                keys: e => Object.keys(e).filter(n.dx.is)
            }
        })
    },
    517854(e, i, t) {
        ...
        let s = (0, n.createContext)({
            triggerCommand(e, i, t = !1) {
                if (t) return !1;
                (0, o.b)(e, i)
            },
            registerLimitedKeybindingScope: () => {}
        });
        s.displayName = "CommandsContext", t.d(i, {}, {
            F: s,
            j: () => (0, n.use)(s)
        })
    },
    349658(e, i, t) {
        ...
        function r() {
            let e = new Map;
            for (let i of new Set(Array.from(d.values()).flatMap(e => s.J.keys(e.commands)))) {
                let t = a.dx.getServiceId(i);
                if (!e.has(t)) {
                    let i = (0, a.tp)(t);
                    e.set(t, {
                        service: {
                ...
                let n = (0, a.fL)(i),
                    o = (0, a.eY)(i);
                n && o.length > 0 && e.get(t) ? .commands.push({
                    id: i,
                    name: n.name,
                    description: n.description,
                    keybinding: o.length > 1 ? o : o[0]
                })
            }
        ...
        t.d(i, {
            ...
            JT: (e, i) => {
                let t, s, a = (0, n.c)(5),
                    r = (0, o.useId)();
                a[0] !== i || a[1] !== e || a[2] !== r ? (t = () => (d.set(r, {
                    commands: i,
                    scopeType: e
                }), () => {
                    d.delete(r)
                }), s = [i, e, r], a[0] = i, a[1] = e, a[2] = r, a[3] = t, a[4] = s) : (t = a[3], s = a[4]), (0, o.useEffect)(t, s)
            },
            hd: () => {
                let e = {};
                for (let i of d.values())
                    if ("global" === i.scopeType)
                        for (let [t, n] of s.J.entries(i.commands)) e[t] = n;
                return e
            }
        })
    },
    ...
    378875(e, i, t) {
        ...
        let d = ({
            ...
            return c ? (0, n.jsx)(o.K, {
                "aria-label": t ? ? c.name,
                onClick: e => {
                    d ? .(e), e.defaultPrevented || u(i, e.nativeEvent)
                },
                icon: r,
                ref: e,
                keybindingHint: (0, s.LU)(i),
                ...l
            }) : null
        };
        d.displayName = "CommandIconButton", d.displayName = "CommandIconButton", t.d(i, {}, {
            N: d
        })
    },
    812652(e, i, t) {
        ...
        class m extends Event {
            ...
            domEvent;
            constructor(e, i) {
                super(f), this.commandId = e, this.domEvent = i
            }
        }
        let f = "ui-command-trigger";

        function g(e, i) {
            document.dispatchEvent(new m(e, i))
        }
        let h = (e, i) => {
                let t = (0, r.hd)()[e];
                if (!t) return !1; {
            ...
            v = e => {
                let i, t, l, m, g = (0, o.c)(7),
                    {
                        commands: v
                    } = e,
                    b = (0, s.useRef)(null),
                    k = (0, s.useEffectEvent)(B),
                    S = (0, u.r)(h);
                g[0] !== S ? (i = e => {
                    let i = function(e) {
                        let i = w.get(e);
                    ...
                    i && !(0, p.Yq)(i, b.current) || y(e) || S(e, (0, d.fg)(a.J.keys((0, r.hd)())))
                }, g[0] = S, g[1] = i) : i = g[1];
                let x = (0, s.useEffectEvent)(i);
                return (0, c.A)("global", v), (0, r.JT)("global", v), g[2] !== k || g[3] !== x ? (t = () => {
                ...
                }, g[2] = k, g[3] = x, g[4] = t) : t = g[4], g[5] === Symbol.for("react.memo_cache_sentinel") ? (l = [], g[5] = l) : l = g[5], (0, s.useEffect)(t, l), g[6] === Symbol.for("react.memo_cache_sentinel") ? (m = (0, n.jsx)("div", {
                    ref: b,
                    className: "d-none"
                }), g[6] = m) : m = g[6], m
            };
        v.displayName = "GlobalCommands";
        let w = new WeakMap,
            b = new WeakMap;

        function y(e) {
            return !!b.has(e) || (b.set(e, !0), !1)
        }

        function B(e) {
            if (!(e instanceof m) || y(e)) return;
            let {
                commandId: i,
                domEvent: t
            } = e;
    ...
    631645(e, i, t) {
        ...
        function a(e, i) {
            ...
            s.send({
                ...
                trigger_type: i instanceof KeyboardEvent ? "keybinding" : "click",
                target_element_html: i.target instanceof HTMLElement ? (n = (t = i.target).tagName.toLowerCase(), a = Array.from(t.attributes).map(e => `${e.name}="${e.value.replaceAll('"','\\"')}"`).join(" "), `<${n}${a?` ${a}`:""}>`) : void 0,
                keybinding: (0, o.LU)(e.commandId)
            })
        }
        t.d(i, {
            T: () => a
    ...
    592058(e, i, t) {
        ...
        var n = t(580676),
            ...
            l = t(794771);
        let c = e => {
            let i, t, n, d, r = (0, a.c)(8);
            r[0] !== e ? ({
                commandId: i,
                ...t
            } = e, r[0] = e, r[1] = i, r[2] = t) : (i = r[1], t = r[2]), r[3] !== i ? (n = (0, o.LU)(i), r[3] = i, r[4] = n) : n = r[4];
            let c = n;
            return r[5] !== c || r[6] !== t ? (d = c ? (0, s.jsx)(l.U, {
                keys: c,
                ...t
            }) : null, r[5] = c, r[6] = t, r[7] = d) : d = r[7], d
        };
        c.displayName = "CommandKeybindingHint";
        let u = e => {
            let i, t, n, l, u, p, m, f, g, h, v, w, b, y = (0, a.c)(29);
            y[0] !== e ? ({
                commandId: t,
                children: i,
                description: n,
                ...
                trailingVisual: p,
                ...l
            } = e, y[0] = e, y[1] = i, y[2] = t, y[3] = n, y[4] = l, y[5] = u, y[6] = p) : (i = y[1], t = y[2], n = y[3], l = y[4], u = y[5], p = y[6]), y[7] !== t ? (m = (0, o.fL)(t), y[7] = t, y[8] = m) : m = y[8];
            let B = m,
                {
                    triggerCommand: k
                } = (0, r.j)();
            return B ? (y[9] !== t || y[10] !== k ? (f = e => k(t, e.nativeEvent), y[9] = t, y[10] = k, y[11] = f) : f = y[11], y[12] !== i || y[13] !== B ? (g = i ? ? (0, s.jsx)("span", {
                children: B.name
            }), y[12] = i, y[13] = B, y[14] = g) : g = y[14], y[15] !== n ? (h = n ? (0, s.jsx)(d.l.Description, {
                truncate: !0,
                children: n
            }) : null, y[15] = n, y[16] = h) : h = y[16], y[17] !== u ? (v = u ? (0, s.jsx)(d.l.LeadingVisual, {
                children: u
            }) : null, y[17] = u, y[18] = v) : v = y[18], y[19] !== t || y[20] !== p ? (w = null !== p && (0, s.jsxs)(d.l.TrailingVisual, {
            ...
            }), y[19] = t, y[20] = p, y[21] = w) : w = y[21], y[22] !== l || y[23] !== f || y[24] !== g || y[25] !== h || y[26] !== v || y[27] !== w ? (b = (0, s.jsxs)(d.l.Item, { ...l,
                onSelect: f,
                children: [g, h, v, w]
            }), y[22] = l, y[23] = f, y[24] = g, y[25] = h, y[26] = v, y[27] = w, y[28] = b) : b = y[28], b) : null
        };
        u.displayName = "CommandActionListItem", u.displayName = "ActionList.CommandItem";
        var p = t(121373);
        let m = e => {
            let i, t, n, o, d = (0, a.c)(6),
                {
                    commandId: r
                } = e;
            return d[0] === Symbol.for("react.memo_cache_sentinel") ? (i = (0, s.jsx)("span", {
                className: "sr-only",
                children: "("
            }), d[0] = i) : i = d[0], d[1] !== r ? (t = (0, s.jsx)(c, {
                commandId: r,
                format: "condensed"
            }), d[1] = r, d[2] = t) : t = d[2], d[3] === Symbol.for("react.memo_cache_sentinel") ? (n = (0, s.jsx)("span", {
                className: "sr-only",
                children: ")"
            }), d[3] = n) : n = d[3], d[4] !== t ? (o = (0, s.jsxs)(s.Fragment, {
                children: [i, t, n]
            }), d[4] = t, d[5] = o) : o = d[5], o
        };
        m.displayName = "ButtonKeybindingHint";
        let f = e => {
            let i, t, n, d, l, c, u, f, g, h, v, w = (0, a.c)(24);
            w[0] !== e ? ({
                ref: l,
                commandId: t,
                children: i,
                trailingVisual: u,
                showKeybindingHint: c,
                onClick: n,
                ...d
            } = e, w[0] = e, w[1] = i, w[2] = t, w[3] = n, w[4] = d, w[5] = l, w[6] = c, w[7] = u) : (i = w[1], t = w[2], n = w[3], d = w[4], l = w[5], c = w[6], u = w[7]);
            let b = void 0 !== c && c;
            w[8] !== t ? (f = (0, o.fL)(t), w[8] = t, w[9] = f) : f = w[9];
            let y = f,
                {
                    triggerCommand: B
                } = (0, r.j)();
            if (!y) return null;
            w[10] !== t || w[11] !== n || w[12] !== B ? (g = e => {
                n ? .(e), e.defaultPrevented || B(t, e.nativeEvent)
            }, w[10] = t, w[11] = n, w[12] = B, w[13] = g) : g = w[13], w[14] !== t || w[15] !== b || w[16] !== u ? (h = u ? ? (b ? (0, s.jsx)(m, {
                commandId: t
            }) : void 0), w[14] = t, w[15] = b, w[16] = u, w[17] = h) : h = w[17];
            let k = i ? ? y.name;
            return w[18] !== d || w[19] !== l || w[20] !== g || w[21] !== h || w[22] !== k ? (v = (0, s.jsx)(p.Q, { ...d,
                onClick: g,
                trailingVisual: h,
                ref: l,
                children: k
            }), w[18] = d, w[19] = l, w[20] = g, w[21] = h, w[22] = k, w[23] = v) : v = w[23], v
        };
        f.displayName = "CommandButton", f.displayName = "CommandButton";
        var g = t(378875),
            h = t(812652),
            v = t(906283),
            w = t(657823),
        ...
        let q = new Map,
            C = ({
                ...
                let o = (0, w.M)(i),
                    a = (0, r.j)(),
                    d = (0, y.useCallback)((e, i, t = !1) => {
                        let s = o.current[e];
                        if (!s) return a.triggerCommand(e, i, t); {
                            let t = new n.k(e);
                            try {
                                s(t)
                            } finally {
                ...
                (0, S.A)("scoped", i), (0, B.JT)("scoped", i);
                let [l, c] = (0, y.useState)(q), u = (0, y.useCallback)((e, i) => c(t => {
                    let n = t.get(e);
                    return i.length === n ? .length && i.every((e, i) => n[i] === e) ? t : new Map([...t, [e, i]])
                }), []), p = (0, y.useMemo)(() => {
                    let e = new Set(Array.from(l.values()).flat());
                    return n.J.keys(i).filter(t => void 0 !== i[t] && !e.has(t))
                }, [i, l]), m = (0, y.useMemo)(() => ({
                    triggerCommand: d,
                    registerLimitedKeybindingScope: u
                }), [d, u]);
                return (0, s.jsx)(r.F, {
                    value: m,
                    children: (0, s.jsx)(M, {
        ...
        C.displayName = "ScopedCommands";
        let M = e => {
            let i, t, n, d, l, c, u, p, m, f, g, h, w, B, k = (0, a.c)(29);
            k[0] !== e ? ({
                ref: n,
                commandIds: t,
                as: i,
                limited: l,
                triggerOnDefaultPrevented: c,
                ...d
            } = e, k[0] = e, k[1] = i, k[2] = t, k[3] = n, k[4] = d, k[5] = l, k[6] = c) : (i = k[1], t = k[2], n = k[3], d = k[4], l = k[5], c = k[6]);
            let S = void 0 !== l && l,
                q = (0, r.j)();
            k[7] !== S || k[8] !== q ? (u = (e, i) => q.triggerCommand(e, i, S), k[7] = S, k[8] = q, k[9] = u) : u = k[9];
            let C = u;
            k[10] !== t ? (p = (0, o.fg)(t), k[10] = t, k[11] = p) : p = k[11];
            let M = p;
            k[12] !== c ? (m = {
                triggerOnDefaultPrevented: c
            }, k[12] = c, k[13] = m) : m = k[13];
            let j = (0, x.r)(C, m);
            k[14] !== j || k[15] !== M ? (f = e => j(e, M), k[14] = j, k[15] = M, k[16] = f) : f = k[16];
            let O = f,
                E = (0, v._)(O),
                I = (0, y.useRef)(null),
                A = (0, b.a)(n ? ? null, I),
                N = (0, y.useEffectEvent)(E.onKeyDown);
            k[17] !== N ? (g = () => {
                let e = I.current;
                if (e) return e.addEventListener("keydown", N), () => e.removeEventListener("keydown", N)
            }, k[17] = N, k[18] = g) : g = k[18], k[19] === Symbol.for("react.memo_cache_sentinel") ? (h = [], k[19] = h) : h = k[19], (0, y.useEffect)(g, h), k[20] !== i || k[21] !== d ? (w = void 0 !== i || void 0 !== d.className ? void 0 : {
                display: "contents"
            }, k[20] = i, k[21] = d, k[22] = w) : w = k[22];
            let _ = w,
                T = i ? ? "div";
            return k[23] !== T || k[24] !== E || k[25] !== A || k[26] !== d || k[27] !== _ ? (B = (0, s.jsx)(T, {
                style: _,
                ...d,
                ...E,
                ref: A
            }), k[23] = T, k[24] = E, k[25] = A, k[26] = d, k[27] = _, k[28] = B) : B = k[28], B
        };
        M.displayName = "KeyboardScope";
        let j = e => {
            let i, t, n, o, d, l, c, u, p = (0, a.c)(17);
            p[0] !== e ? ({
                ref: t,
                commandIds: i,
                ...n
            } = e, p[0] = e, p[1] = i, p[2] = t, p[3] = n) : (i = p[1], t = p[2], n = p[3]);
            let m = (0, r.j)(),
                f = (0, y.useId)();
            return p[4] !== i || p[5] !== m || p[6] !== f ? (o = () => m.registerLimitedKeybindingScope(f, i), d = [m, i, f], p[4] = i, p[5] = m, p[6] = f, p[7] = o, p[8] = d) : (o = p[7], d = p[8]), (0, y.useEffect)(o, d), p[9] !== m || p[10] !== f ? (l = () => () => m.registerLimitedKeybindingScope(f, []), c = [m, f], p[9] = m, p[10] = f, p[11] = l, p[12] = c) : (l = p[11], c = p[12]), (0, y.useEffect)(l, c), p[13] !== i || p[14] !== t || p[15] !== n ? (u = (0, s.jsx)(M, {
                limited: !0,
                commandIds: i,
                ...n,
                ref: t
            }), p[13] = i, p[14] = t, p[15] = n, p[16] = u) : u = p[16], u
        };
        j.displayName = "LimitKeybindingScope";
        let O = Object.assign(C, {
            LimitKeybindingScope: j
        })
    },
    245405(e, i, t) {
        var n = t(916522),
        ...
        function l(e, i) {
            let t, l, c, u = (0, n.c)(5);
            u[0] === Symbol.for("react.memo_cache_sentinel") ? (t = new Map, u[0] = t) : t = u[0];
            let p = t,
                m = "global" === e ? r : p;
            u[1] !== i || u[2] !== m ? (l = () => {
                for (let [e, t] of (0, a.hq)(s.J.keys(i))) {
                    let i = m.get(t) ? .filter(i => i !== e) ? ? [];
                    i.length && console.warn(`The keybinding (${t}) for the "${e}" command conflicts with the keybinding for the already-registered command(s) "${i.join(", ")}". This may result in unpredictable behavior.`), m.set(t, i.concat(e))
                }
                return () => {
                    for (let [e, t] of (0, a.hq)(s.J.keys(i))) {
                        let i = (0, d.CV)(m.get(t) ? ? [], e);
                        i ? .length ? m.set(t, i) : m.delete(t)
                    }
                }
            }, c = [i, m], u[1] = i, u[2] = m, u[3] = l, u[4] = c) : (l = u[3], c = u[4]), (0, o.useEffect)(l, c)
        }
        t.d(i, {
            A: () => l
        })
    ...
    758799(e, i, t) {
        ...
        function r(e, i) {
            let t, r, l, c = (0, n.c)(6);
            c[0] !== i ? (t = void 0 === i ? {} : i, c[0] = i, c[1] = t) : t = c[1];
            let {
                triggerOnDefaultPrevented: u
            } = t, p = void 0 !== u && u;
            c[2] === Symbol.for("react.memo_cache_sentinel") ? (r = new o.KK, c[2] = r) : r = c[2];
            let m = r,
                f = (0, a.useRef)(null);
            return c[3] !== e || c[4] !== p ? (l = (i, t) => {
                let n, o = "nativeEvent" in i ? i.nativeEvent : i;
                if ((p || !o.defaultPrevented) && f.current !== o) {
                    if (f.current = o, !(0, s.$$)(o)) return void m.reset();
                    for (let e of (m.registerKeypress(o), (0, d.P0)(m.sequence)))
                        if (n = t.get(e)) break;
                    !n || (e(n, o) ? ? !0) && (m.reset(), i.preventDefault(), i.stopPropagation(), o.stopImmediatePropagation())
                }
            }, c[3] = e, c[4] = p, c[5] = l) : l = c[5], l
        }
        t.d(i, {
            r: () => r
        })
    ...
    636597(e, i, t) {
        ...
        function o(e, i) {
            let t = !1;
            return e.filter(e => e !== i || !!t || (t = !0, !1))
        }
        let s = '[role="dialog"][aria-modal="true"]';

        function a() {
            let e = [...document.querySelectorAll(function() {
                if (void 0 !== n) return n;
                let e = `dialog:modal, ${s}`;
                try {
                    document.createDocumentFragment().querySelectorAll(e), n = e
                } catch {
                    n = s
                }
                return n
            }())].filter(e => e.childNodes.length > 0 && function e(i) {
                if (i.clientHeight > 0) return !0;
        ...
        function d(e, i) {
            return !!i && (e.contains(i) ? ? !1)
        }

        function r(e) {
            let i = e.split(" "),
                t = [];
            for (; i.length >= 1;) t.push(i.join(" ")), i.shift();
            return t
        }
        t.d(i, {
            CV: () => o,
    ...
    906283(e, i, t) {
        ...
        t.d(i, {}, {
            _: e => {
                let i, t, d, r = (0, n.c)(5),
                    l = (0, s.useRef)(!1);
                r[0] === Symbol.for("react.memo_cache_sentinel") ? (i = e => {
                    "compositionstart" === e.type && (l.current = !0), "compositionend" === e.type && (l.current = !1)
                }, r[0] = i) : i = r[0];
                let c = i;
                r[1] !== e ? (t = i => {
                    let t = i.nativeEvent,
                        n = t && "isComposing" in t && t.isComposing,
                        s = "Process" === i.key;
                    if ((0, o.U0)() && 229 === i.keyCode) return;
                    let d = l.current || n || s;
    ...
    657823(e, i, t) {
        ...
        function s(e) {
            ...
            return s[0] !== e ? (i = () => {
                a.current = e
            }, t = [e], s[0] = e, s[1] = i, s[2] = t) : (i = s[1], t = s[2]), (0, o.useEffect)(i, t), a
        }
        ...
        function a(e) {
            ...
            return s[0] !== e ? (i = () => {
                a.current = e
            }, t = [e], s[0] = e, s[1] = i, s[2] = t) : (i = s[1], t = s[2]), (0, o.useLayoutEffect)(i, t), a
        }
        t.d(i, {
            M: () => s,
            y: () => a
...
//# sourceMappingURL=4871-323a6754c189b6a8-da2e9f322a99ca35.js.map