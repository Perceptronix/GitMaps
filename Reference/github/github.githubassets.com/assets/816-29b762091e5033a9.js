performance.mark("js-parse-end:816-29b762091e5033a9.js");
export const __rspack_esm_id = 816;
export const __rspack_esm_ids = [816];
    ...
    325587(t, e, i) {
        ...
        class n {
                ...
                this.input = t, this.list = e, this.tabInsertsSuggestions = null == i || i, this.defaultFirstOption = null != n && n, this.scrollIntoViewOptions = null != s ? s : {
                    ...
                    if (!t.shiftKey && !t.metaKey && !t.altKey && (e.ctrlBindings || !t.ctrlKey) && !e.isComposing) switch (t.key) {
                        case "Enter":
                            ...
                            break;
                        case "Tab":
                            e.tabInsertsSuggestions && o(e.input, e.list) && t.preventDefault();
                            break;
                        case "Escape":
                            e.clearSelection();
                            break;
            ...
            indicateDefaultOption() {
                var t;
                this.defaultFirstOption && (null == (t = Array.from(this.list.querySelectorAll('[role="option"]:not([aria-disabled="true"])')).filter(r)[0]) || t.setAttribute("data-combobox-option-default", "true"))
            }
            navigate(t = 1) {
                let e = Array.from(this.list.querySelectorAll('[aria-selected="true"]')).filter(r)[0],
                    i = Array.from(this.list.querySelectorAll('[role="option"]')).filter(r),
                    n = i.indexOf(e);
                ...
                let o = i[s];
                if (o)
                    for (let t of i) t.removeAttribute("data-combobox-option-default"), o === t ? (this.input.setAttribute("aria-activedescendant", o.id), o.setAttribute("aria-selected", "true"), o.dispatchEvent(new Event("combobox-select", {
                        bubbles: !0
                    })), o.scrollIntoView(this.scrollIntoViewOptions)) : t.removeAttribute("aria-selected")
            }
            clearSelection() {
        ...
        class c extends EventTarget {#
            ...
            for (t) {
                let e = h.get(t);
                return e || (e = new c(t), h.set(t, e)), e
            }
            constructor(t) {
                super(), this.#s = new WeakRef(t), this.#o.style.position = "absolute", this.#o.style.pointerEvents = "none", this.#o.setAttribute("aria-hidden", "true"), this.#o.appendChild(this.#r), this.#r.style.pointerEvents = "none", this.#r.style.userSelect = "none", this.#r.style.overflow = "hidden", this.#r.style.display = "block", this.#r.style.visibility = "hidden", t instanceof HTMLTextAreaElement ? (this.#r.style.whiteSpace = "pre-wrap", this.#r.style.wordWrap = "break-word") : (this.#r.style.whiteSpace = "nowrap", this.#r.style.display = "table-cell", this.#r.style.verticalAlign = "middle"), t.after(this.#o), this.#e(), this.#l(), this.#t.observe(t, {
                    attributeFilter: ["style", "dir"]
                }), this.#i.observe(t), document.addEventListener("scroll", this.#a, {
                    capture: !0
            ...
            disconnect() {
                this.#o ? .remove(), this.#t.disconnect(), this.#i.disconnect(), document.removeEventListener("scroll", this.#a, {
                    capture: !0
                }), window.removeEventListener("resize", this.#a, {
                    capture: !0
                });
                let t = this.#c;
                t && (t.removeEventListener("input", this.#h, {
                    capture: !0
                }), h.delete(t))
            }
            get# c() {
            ...
            m() {
                this.#u(t => {
                    ...
                    this.#r.style.height = e.height, this.#r.style.width = e.width, t.clientHeight !== this.#r.clientHeight && (this.#r.style.height = `calc(${e.height} + ${t.clientHeight-this.#r.clientHeight}px)`), t.clientWidth !== this.#r.clientWidth && (this.#r.style.width = `calc(${e.width} + ${t.clientWidth-this.#r.clientWidth}px)`);
                    let i = t.getBoundingClientRect(),
                        n = this.#r.getBoundingClientRect();
                    this.#d = this.#d + i.left - n.left, this.#p = this.#p + i.top - n.top, this.#r.style.transform = `translate(${this.#d}px, ${this.#p}px)`, this.#r.scrollTop = t.scrollTop, this.#r.scrollLeft = t.scrollLeft, this.dispatchEvent(new a)
                })
            }#
            f = !1;#
            n() {
            ...
            e() {
                this.#u(t => {
                    let e = window.getComputedStyle(t);
                    for (let t of u) this.#r.style[t] = e[t];
                    this.#n()
                })
            }#
            l() {
            ...
            a = t => {
                this.#u(e => {
                    (t.target === document || t.target === window || t.target instanceof Node && t.target.contains(e)) && this.#n()
                })
            }
        }
        let u = ["direction", "writingMode", "unicodeBidi", "textOrientation", "boxSizing", "borderTopWidth", "borderRightWidth", "borderBottomWidth", "borderLeftWidth", "borderStyle", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "fontStyle", "fontVariant", "fontWeight", "fontStretch", "fontSize", "fontSizeAdjust", "lineHeight", "fontFamily", "textAlign", "textTransform", "textIndent", "textDecoration", "letterSpacing", "wordSpacing", "tabSize", "MozTabSize"];
        class d {#
            v;#
            g;#
            b;
            constructor(t, e = 0, i = e) {
                this.#v = t, this.#g = e, this.#b = i
            }
            static fromSelection(t) {
                ...
                return new d(t, e ? ? void 0, i ? ? void 0)
            }
            get collapsed() {
            ...
            collapse(t = !1) {
                t ? this.setEndOffset(this.startOffset) : this.setStartOffset(this.endOffset)
            }
            cloneContents() {
                return this.#y().cloneContents()
            }
            cloneRange() {
                return new d(this.#v, this.startOffset, this.endOffset)
            }
            getBoundingClientRect() {
                return this.#y().getBoundingClientRect()
            }
            getClientRects() {
                return this.#y().getClientRects()
            }
            toString() {
            ...
            y() {
                ...
                return e && (t.setStart(e, this.startOffset), t.setEnd(e, this.endOffset)), t
            }
        }
        let p = new WeakMap;
        class m {
            ...
            positionMenu(t, e) {
                ...
                if (0 !== r.left || 0 !== r.top) {
                    ...
                    t.style.left = e.left ? `calc(${e.left} + ${r.left}px)` : `${r.left}px`, t.style.top = e.top ? `calc(${e.top} + ${r.top}px)` : `${r.top}px`
                }
            }
            deactivate() {
                let t = this.menu;
            ...
            onCommit({
                ...
                this.deactivate(), this.input.focus({
                    preventScroll: !0
                }), this.input.selectionStart = a, this.input.selectionEnd = a, o.continue || (this.lookBackIndex = a, this.match = null), this.expander.dispatchEvent(new CustomEvent("text-expander-committed", {
                    cancelable: !1,
                    detail: {
                        input: this.input
                    }
            ...
            isMatchStillValid(t) {
                return t.position <= this.input.value.length
            }
            async onInput() {
                if (this.justPasted) {
                    this.justPasted = !1;
                ...
                if (t) {
                    ...
                    if (!this.match || !this.isMatchStillValid(t)) {
                        this.match = null, this.deactivate();
                        return
                    }
            ...
            async notifyProviders(t) {
                ...
                if (this.expander.dispatchEvent(i)) return (await Promise.all(e)).filter(t => t.matched).map(t => t.fragment)[0]
            }
            onMousedown() {
        ...
        window.customElements.get("text-expander") || (window.TextExpanderElement = f, window.customElements.define("text-expander", f))
    }
};
//# sourceMappingURL=816-29b762091e5033a9-81ad79b85aa33018.js.map