performance.mark("js-parse-end:runtime-helpers-b5a5a1cee32a4b87.js");
export const __rspack_esm_id = 13726;
export const __rspack_esm_ids = [13726];
    ...
    331635(t, n, e) {
        ...
        function o(t, n, e, r) {
            var o, c = arguments.length,
                i = c < 3 ? n : null === r ? r = Object.getOwnPropertyDescriptor(n, e) : r;
            if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) i = Reflect.decorate(t, n, e, r);
            else
                for (var u = t.length - 1; u >= 0; u--)(o = t[u]) && (i = (c < 3 ? o(i) : c > 3 ? o(n, e, i) : o(n, e)) || i);
            return c > 3 && i && Object.defineProperty(n, e, i), i
        }
        ...
        function i(t, n, e) {
            ...
            return r = Object.create(("function" == typeof AsyncIterator ? AsyncIterator : Object).prototype), u("next"), u("throw"), u("return", function(t) {
                return function(n) {
                    return Promise.resolve(n).then(t, l)
                }
            ...
            function f(t, n) {
                try {
                    var e;
                    (e = o[t](n)).value instanceof c ? Promise.resolve(e.value.v).then(a, l) : s(i[0][2], e)
                } catch (t) {
                    s(i[0][3], t)
                }
            }
            ...
            function s(t, n) {
                t(n), i.shift(), i.length && f(i[0][0], i[0][1])
            }
        }
        ...
        function f(t) {
            ...
            return e ? e.call(t) : (t = function(t) {
            ...
            }(t), n = {}, r("next"), r("throw"), r("return"), n[Symbol.asyncIterator] = function() {
                return this
            }, n);
            ...
            function r(e) {
                n[e] = t[e] && function(n) {
                    return new Promise(function(r, o) {
                        var c, i, u;
                        c = r, i = o, u = (n = t[e](n)).done, Promise.resolve(n.value).then(function(t) {
                            c({
                                value: t,
                                done: u
                            })
...
//# sourceMappingURL=runtime-helpers-b5a5a1cee32a4b87-49a533001b9aad21.js.map