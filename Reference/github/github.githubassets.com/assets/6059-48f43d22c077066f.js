performance.mark("js-parse-end:6059-48f43d22c077066f.js");
export const __rspack_esm_id = 6059;
export const __rspack_esm_ids = [6059];
export const __webpack_modules__ = {
    736963(e, t, n) {
        ...
        function i() {
            ...
            e.currentTarget !== e.target || "abort" !== t && "canceled" !== t && (/<html/.test(n) ? (o(), e.stopImmediatePropagation()) : setTimeout(function() {
    ...
    365552(e, t, n) {
        ...
        function d(e, t) {
            ...
            ! function(e, t) {
                ...
                let t;
                s(r, o);
                let n = d ? (t = r.getAttribute("data-details-container-group")) ? ((0, c._H)(r, () => {
                    for (let e of [...document.querySelectorAll(".js-details-container")].filter(e => e.getAttribute("data-details-container-group") === t)) e !== r && s(e, o)
                }), t) : null : null;
                Promise.resolve().then(() => {
                    [".js-focus-on-dismiss", "input[autofocus], textarea[autofocus]"].find(e => {
                        let t = Array.from(r.querySelectorAll(e)).findLast(e => "none" !== window.getComputedStyle(e).display);
                        ...
                        once: !0
                    })), r.dispatchEvent(new CustomEvent("details:toggled", {
                        bubbles: !0,
                        cancelable: !1,
                        detail: {
                            open: o
                        }
                    })), n && r.dispatchEvent(new CustomEvent("details:toggled-group", {
                        bubbles: !0,
                        cancelable: !1,
                        detail: {
                            open: o,
    ...
    361382(e, t, n) {
        ...
        function s(e, t) {
            ...
            return !!n && (n.classList.add("render-error"), n.querySelector(".js-render-block-actions") ? .remove(), l.get(n) ? .setError(!0, t))
        }
  ...
  `
        }(0, o.l)(".js-render-needs-enrichment", {
            ...
            initialize: function(e) {
                ...
                let b = {
                    ...
                    setError: (e, t) => (b.setLoading(!1), !1 !== e && (y.classList.toggle("render-plaintext-hidden", !e), !!t && ((0, r.XX)([t, y], g), !0)))
                };
                l.set(e, b);
                let v = m.getAttribute("data-plain"),
                    w = m.getAttribute("data-json");
                if (null == w || null == v) throw b.setError(!0, (0, r.qy)
                    `<p class="flash flash-error">Unable to render rich display</p>`), Error(`Expected to see input data for type: ${s}`);
                let E = d(u, c, {
                        type: s,
                        identifier: f,
                        contentJson: w
  ...
  >
    ${i}${o}
                ...
                p && !p.open ? p.addEventListener("toggle", () => {
                    p.open && (0, r.XX)([A, E], m)
                }, {
                    once: !0
                }) : (0, r.XX)([A, E], m)
    ...
    323811(e, t, n) {
        ...
        function l(e) {
            !async function() {
                let t;
                i.push(e), await r.G, t = a, a = i.length, c(i.slice(t), null, window.location.href)
            }()
        }
    ...
    69353(e, t, n) {
        ...
        function a(e, t) {
            ...
            let r = t && e instanceof CustomEvent && e.detail ? .error ? .message ? .includes("responded with a status of 403");
            for (let e of n.querySelectorAll("[data-show-on-forbidden-error]")) e instanceof HTMLElement && (e.hidden = !r);
            for (let e of n.querySelectorAll("[data-show-on-error]")) e instanceof HTMLElement && (e.hidden = r || !t);
        ...
        }(0, o.l)("include-fragment, poll-include-fragment", {
            subscribe: e => (0, r.Zz)((0, r.Rt)(e, "error", c), (0, r.Rt)(e, "loadstart", l))
    ...
    16442(e, t, n) {
        ...
        let c = ["is-render-pending", "is-render-ready", "is-render-loading", "is-render-loaded"],
        ...
        function f(e, t = "") {
            var n, i;
            let a;
            e.classList.remove(...c), e.classList.add("is-render-failed");
            let l = function(e) {
                let t = (0, r.qy)
                `<p>Unable to render rich display</p>`;
                if ("" !== e) {
                    let n = e.split("\n");
                    t = (0, r.qy)
                    `<p><b>Unable to render rich display</b></p>
      <p>${n.map(e=>(0,r.qy)`${e}<br />`)}</p>`
                }
                return (0, r.qy)
                `<div class="flash flash-error">${t}</div>`
            }(t);
            !1 === (0, o.L)(e, l) && (n = e, i = l, (a = n.querySelector(".render-viewer-error")) && (a.remove(), n.classList.remove("render-container"), (0, r.XX)(i, n))), u(e)
        }

        function m(e, t = !1) {
            !(!e || !(0, a.A)(e) || e.classList.contains("is-render-ready") || e.classList.contains("is-render-failed") || e.classList.contains("is-render-failed-fatally")) && (!t || d.get(e) ? .hello) && f(e)
        }

        function h(e, t, n) {
            return !!e && !!e.postMessage && (e.postMessage(JSON.stringify(t), n), !0)
        }
        ...
        function p(e) {
        ...
        }(0, i.l)(".js-render-target", function(e) {
            e.classList.remove(...s), e.style.height = "auto", d.get(e) ? .load || (u(e), d.get(e) || (d.set(e, {
                load: Date.now(),
                hello: null,
            ...
            if ("object" != typeof t && void 0 != t || "render" !== t.type || "string" != typeof t.identity) return;
            let n = t.identity;
            if ("string" != typeof t.body) return;
            let r = t.body,
                i = function(e, t) {
                    for (let n of e.querySelectorAll(".js-render-target[data-identity][data-host]"))
            ...
            switch (r) {
                ...
                case "error:invalid":
                    ...
                    break;
                case "loading":
                    i.classList.remove(...c), i.classList.add("is-render-loading");
                    break;
                case "loaded":
                    i.classList.remove(...c), i.classList.add("is-render-loaded");
                    break;
                case "ready":
                    (0, o.A)(i), i.classList.remove(...c), i.classList.add("is-render-ready"), l && "number" == typeof l.height && (i.style.height = `${l.height}px`, "" !== location.hash && window.dispatchEvent(new HashChangeEvent("hashchange"))), l ? .ack === !0 && window.requestAnimationFrame(() => {
                        setTimeout(() => {
                            h(u, {
                                type: "render:cmd",
                                body: {
                    ...
                    break;
                case "resize":
                    l && "number" == typeof l.height && (i.style.height = `${l.height}px`);
                    break;
                ...
                case "code_rendering_service:markdown:get_data":
                    let m;
                    if (!u) return;
                    let p = s ? .getAttribute("data-content") ? ? "";
                    try {
                        m = JSON.parse(p) ? .data
                    } catch {
                        m = null
    ...
    293530(e, t, n) {
                ...
                for (let t of e) {
                    ...
                    if (e instanceof HTMLElement) {
                        let t = e.ownerDocument.documentElement,
                            n = e.clientHeight;
                        n !== i && (r && cancelAnimationFrame(r), r = requestAnimationFrame(() => {
        ...
        function l() {
            return i
        }(0, o.l)(".js-observe-sticky-header-height", {
            constructor: HTMLElement,
            add(e) {
                a.observe(e)
            }
    ...
    116410(e, t, n) {
        ...
        async function l(e) {
            ...
            if (t && t.defaultView) {
                ...
                n ? t.defaultView.scrollBy(0, -s() - n.clientHeight) : t.defaultView.scrollBy(0, -s())
            }
        }
    ...
    538395(e, t, n) {
        ...
        function l(e) {
            ...
            return t && t[1] ? Object.freeze({
                line: parseInt(t[1]),
                column: n && n[1] ? parseInt(n[1]) : null
            }) : null
        }

        function c(e, t) {
            let [n, r] = s(e.start, !0, t), [o, i] = s(e.end, !1, t);
            if (!n || !o) return;
            let a = r,
                l = i;
            if (-1 === a && (a = 0), -1 === l && (l = o.childNodes.length), !n.ownerDocument) throw Error("DOMRange needs to be inside document");
            let c = n.ownerDocument.createRange();
            return c.setStart(n, a), c.setEnd(o, l), c
        }
    ...
    444507(e, t, n) {
        ...
        function a(e, t, n = null, r = !1, o = "lax", i = !1) {
            ...
            !1 === r && (l = `.${l}`);
            try {
                document.cookie = `${e}=${t}; path=/; domain=${l}${s}${c}; samesite=${o}${i?"; partitioned":""}`
            } catch {}
        }
    ...
    345593(e, t, n) {
        ...
        function i(e, t) {
            ...
            }(e, t), (0, r.A)(t)), o(e, "submit", !0) && e.submit()
        }
        ...
        function d(e, t) {
            ...
            for (let [e, r] of s(t)) n.append(e, r);
            return n.toString()
        }
    ...
    864689(e, t, n) {
        ...
        function s(e, t = !1, n = !1) {
            ...
            return !n && d(e) || function(e, t) {
                ...
                return null !== n && (!t || n !== e) && (!!(n === e && (0, l.Z8)(n) || e.contains(n) && ! function(e) {
                    ...
                    let r = e.closest(u);
                    return !!r && r === i.closest(u)
                }(n)) || i instanceof Element && e.contains(i) && !!i.closest("details[open] > summary"))
            }(e, t) || (c = e).matches(":active:enabled") || c.contains(o) || !!((f = e).closest(".is-dirty") || f.querySelector(".is-dirty"))
        }
        ...
        c.XC ? .addEventListener("mousedown", function(e) {
            o = e.target
        }, !0), c.XC ? .addEventListener("mouseup", function(e) {
            o = null, i = e.target
        }, !0), c.XC ? .addEventListener("contextmenu", function(e) {
            o = null, i = e.target
        }, !0), c.XC ? .addEventListener("dragend", function() {
            o = null
        }, !0);
        let u = "a[href], button";
        n.d(t, {
    ...
    137923(e, t, n) {
        ...
        function c(e) {
            ...
            o && (o = t), p(t, "", location.href)
        }

        function s(e) {
            a(`?${e.toString()}${r.fV.hash}`)
        }

        function d() {
            a(r.fV.pathname + r.fV.hash)
        }

        function u(e) {
            a(e.startsWith("#") ? e : `#${e}`), (o = i()) && requestIdleCallback(() => {
                !history.state && o && (c(o), o = null)
            })
        }

        function f() {
            a(r.fV.pathname + r.fV.search)
        }
        ...
        function p(e, t, n) {
            r.Kn ? .replaceState(e, t, n), g()
        }

        function g() {
            r.cg ? .dispatchEvent(new CustomEvent("statechange", {
                bubbles: !1,
                cancelable: !1
            }))
        }
    ...
    384617(e, t, n) {
        ...
        function o(e, t, n) {
            ...
            let l = "";
            try {
                l = JSON.parse(e).event_name
            } catch {}(0, r.iv)(o, !0, l ? .startsWith("staff_bar.") ? 1 : void 0)
        }

        function i(e) {
            o(e.getAttribute("data-hydro-view") || "", e.getAttribute("data-hydro-view-hmac") || "", e.getAttribute("data-hydro-client-context") || "")
        }

        function a(e) {
            o(e.getAttribute("data-hydro-click-payload") || "", e.getAttribute("data-hydro-click-hmac") || "", e.getAttribute("data-hydro-client-context") || "")
        }
        n.d(t, {
            $3: () => i,
            HV: () => a,
    ...
    737131(e, t, n) {
        ...
        n.d(t, {}, {
            softNavigate: (e, t) => {
                let n;
                try {
                    n = new URL(String(e), r.cg ? .location.href)
                } catch {
                    return
                }("http:" === n.protocol || "https:" === n.protocol) && (t ? .action === "replace" ? r.cg ? .location.replace(n.href) : r.cg ? .location.assign(n.href))
            }
        })
    },
    155059(e, t, n) {
        ...
        function c(e) {
            for (let t of (r = e, e ? document.body.style.setProperty("--base-sticky-header-height", `${e}px`) : document.body.style.removeProperty("--base-sticky-header-height"), o)) t(e)
        }
        n.d(t, {
            Jd: () => l,
            MG: () => i,
    ...
    760899(e, t, n) {
        ...
        function o(e, t, n, i = {
            ...
            return e.addEventListener(t, n, i), new r(() => {
    ...
    954663(e, t, n) {
        ...
        function f() {
            ...
            let e = (0, c.JV)();
            e.staleRecords = u, (0, c.C3)(e), window.location.reload()
        }

        function m() {
            if (Object.keys(u).length > 0) {
                let e = (0, c.JV)();
                e.staleRecords = u, (0, c.C3)(e)
            }
        }
        async function h(e, t = {
            ...
            try {
                ...
                if (!l.ok) return;
                let c = await l.text();
                if ((0, r.it)(e, n)) return void console.warn("Failed to update content with interactions", e);
                return b(c) ? u[o] = c : delete u[o], g(e, c, {
                    retainFocus: n,
                    activateScripts: t.activateScripts
                }), c
            } catch {} finally {
                d.delete(e)
            }
        ...
        async function p(e, t, n = !1) {
            ...
            return !n && o && o === e && (b(t) ? u[o.getAttribute("data-url") || ""] = t : delete u[o ? .getAttribute("data-url") || ""]), g(e, t, {
                retainFocus: !1,
                activateScripts: !1
            })
        }
        ...
        function g(e, t, n) {
            return (0, a.JR)(document, () => {
                let r = (0, i.B)(document, t.trim());
                n.activateScripts && function(e) {
                    for (let t of [...Array.from(e.querySelectorAll("script[src]")), ...Array.from(e.querySelectorAll("template")).flatMap(e => Array.from(e.content.querySelectorAll("script[src]")))]) ! function(e) {
                        let {
                            src: t
                        } = e;
                        if (!t) return;
                ...
                let o = n.retainFocus && e.ownerDocument && e === e.ownerDocument.activeElement ? r.querySelector("*") : null,
                    a = Array.from(e.querySelectorAll("details[open][id]")).map(e => e.id);
                for (let t of ("DETAILS" === e.tagName && e.id && e.hasAttribute("open") && a.push(e.id), e.querySelectorAll(".js-updatable-content-preserve-scroll-position"))) {
        ...
        }(0, o.l)(".js-updatable-content-preserve-scroll-position", {
            constructor: HTMLElement,
            add(e) {
...
//# sourceMappingURL=6059-48f43d22c077066f-c60247ba07e09430.js.map