performance.mark("js-parse-end:26194-4de6887bb62715e7.js");
export const __rspack_esm_id = 26194;
export const __rspack_esm_ids = [26194];
export const __webpack_modules__ = {
    370409(e, o, a) {
        ...
        var r = {};
        a.r(r), a.d(r, {
            consentControlOptions: () => w,
            cookieCategories: () => x
        });
        var t = {};
        a.r(t), a.d(t, {
            consentControlOptions: () => C,
            cookieCategories: () => H
        });
        var n = {};
        a.r(n), a.d(n, {
            consentControlOptions: () => q,
            cookieCategories: () => G
        });
        var c = {};
        a.r(c), a.d(c, {
        ...
        let u = "Required",
            ...
            p = "SocialMedia",
            b = "Advertising",
            f = "https://docs.github.com/site-policy/privacy-policies/github-privacy-statement",
            h = "https://docs.github.com/site-policy/privacy-policies/github-subprocessors-and-cookies",
            g = "https://docs.github.com/account-and-profile/setting-up-and-managing-your-personal-account-on-github/managing-personal-account-settings/managing-your-cookie-preferences-for-githubs-enterprise-marketing-pages",
            k = {
                [u]: !0,
                [m]: !1,
                [p]: !1,
            ...
            H = [{
                id: u,
                name: "Obrigat\xf3rios",
                descHtml: "O GitHub usa cookies obrigat\xf3rios para realizar fun\xe7\xf5es essenciais do site e fornecer servi\xe7os. Por exemplo, cookies s\xe3o usados para permitir seu login, salvar suas prefer\xeancias de idioma, fornecer uma experi\xeancia de carrinho de compras, melhorar o desempenho, rotear tr\xe1fego entre servidores web, detectar o tamanho da sua tela, determinar tempos de carregamento de p\xe1ginas, melhorar a experi\xeancia de usu\xe1rio e para medi\xe7\xe3o de p\xfablico. Esses cookies s\xe3o necess\xe1rios para que nossos sites funcionem.",
                isUnswitchable: !0
            }, {
                id: m,
                name: "Anal\xedticos",
                descHtml: "Permitimos que terceiros usem cookies anal\xedticos para entender como voc\xea usa nossos sites para que possamos melhor\xe1-los. Por exemplo, cookies s\xe3o usados para coletar informa\xe7\xf5es sobre as p\xe1ginas que voc\xea visita e quantos cliques s\xe3o necess\xe1rios para concluir uma tarefa. Tamb\xe9m usamos cookies anal\xedticos para veicular an\xfancios personalizados."
            }, {
                id: p,
                name: "M\xeddia social",
                descHtml: "O GitHub e terceiros usam cookies de m\xeddia social para mostrar an\xfancios e conte\xfado com base em seus perfis de m\xeddia social e atividade em sites do GitHub. Isso garante que os an\xfancios e o conte\xfado que voc\xea v\xea em nossos sites e redes sociais v\xe3o estar mais alinhados aos seus interesses. Tamb\xe9m permite que terceiros desenvolvam e melhorem seus produtos, que podem ser usados em sites que n\xe3o s\xe3o de propriedade ou operados pelo GitHub."
            }, {
                id: b,
                name: "Publicidade",
                descHtml: "Al\xe9m disso, o GitHub e terceiros usam cookies de publicidade para mostrar novos an\xfancios com base em an\xfancios que voc\xea j\xe1 viu. Os cookies tamb\xe9m rastreiam em quais an\xfancios voc\xea clicou ou compras que realizou ap\xf3s clicar em um an\xfancio. Isso \xe9 feito para veicular os an\xfancios que s\xe3o mais relevantes para voc\xea e para fins comerciais com nossos parceiros de publicidade. Por exemplo, cookies s\xe3o usados para detectar quando voc\xea clica em um an\xfancio e para veicular an\xfancios com base em seus interesses de m\xeddia social e hist\xf3rico de navega\xe7\xe3o em sites."
            }],
            C = {
                textResources: {
                    bannerMessageHtml: `Usamos cookies opcionais para melhorar sua experi\xeancia em nossos sites e para exibir publicidade personalizada com base em sua atividade on-line. Se voc\xea rejeitar os cookies opcionais, somente ser\xe3o usados os cookies necess\xe1rios para fornecer os servi\xe7os listados acima. Voc\xea pode alterar sua escolha de quais cookies voc\xea aceita ao clicar em \u{201C}Gerenciar cookies\u{201D} no parte inferior da p\xe1gina. Essa escolha \xe9 mantida por 180 dias. Revise suas escolhas regularmente. <br/> <br/> <a href="${g}">Como gerenciar prefer\xeancias de cookies</a> | <a href="${f}">Declara\xe7\xe3o de Privacidade</a> | <a href="${h}">Cookies de terceiros</a>.`,
                    acceptAllLabel: "Aceitar",
                    rejectAllLabel: "Rejeitar",
                    moreInfoLabel: "Gerenciar cookies",
                    preferencesDialogCloseLabel: "Fechar",
                    preferencesDialogTitle: "Gerenciar prefer\xeancias de cookies",
                    ...
                    saveLabel: "Salvar altera\xe7\xf5es",
            ...
            L = [{
                id: u,
                name: "Requerido",
                descHtml: "GitHub utiliza las cookies necesarias para ejecutar las funciones esenciales del sitio web y prestar los servicios. Por ejemplo, las cookies se utilizan para iniciar sesi\xf3n, guardar tus preferencias de idioma, proporcionar una buena experiencia con el carrito de la compra, mejorar el rendimiento, dirigir el tr\xe1fico entre servidores web, detectar el tama\xf1o de la pantalla, determinar los tiempos de carga de la p\xe1gina, mejorar la experiencia del usuario y medir la audiencia. Estas cookies son necesarias para que nuestros sitios web funcionen.",
                isUnswitchable: !0
            }, {
                id: m,
                name: "Anal\xedticas",
                descHtml: "Permitimos que los terceros utilicen cookies de an\xe1lisis para comprender c\xf3mo utiliza nuestros sitios web y poder mejorarlos. Por ejemplo, las cookies se utilizan para recopilar informaci\xf3n sobre las p\xe1ginas que visita y cu\xe1ntos clics se necesitan para realizar una tarea. Tambi\xe9n utilizamos algunas cookies de an\xe1lisis para ofrecer publicidad personalizada."
            }, {
                id: p,
                name: "Redes sociales",
                descHtml: "GitHub y otros terceros utilizan cookies de redes sociales para mostrarte anuncios y contenidos basados en tus perfiles de redes sociales y tu actividad en los sitios web de GitHub. Esto garantiza que los anuncios y contenidos que aparecen en nuestros sitios web y en las redes sociales reflejen mejor tus intereses. Esto tambi\xe9n permite a terceros desarrollar y mejorar sus productos, que pueden utilizar en sitios web que no son propiedad ni est\xe1n gestionados por GitHub."
            }, {
                id: b,
                name: "Publicidad",
                descHtml: "Adem\xe1s, GitHub y otros terceros utilizan cookies de publicidad para mostrarte nuevos anuncios basados en los que ya has visto. Las cookies tambi\xe9n rastrean los anuncios en los que haces clic o las compras que realizas despu\xe9s de hacer clic en un anuncio. Lo hacemos para mostrarte anuncios que sean m\xe1s relevantes para ti y con fines comerciales con nuestros socios publicitarios. Por ejemplo, las cookies se utilizan para detectar cu\xe1ndo haces clic en un anuncio y mostrarte anuncios basados en tus intereses en las redes sociales y en tu historial de navegaci\xf3n por el sitio web."
            }],
            $ = {
                textResources: {
                    bannerMessageHtml: `Utilizamos cookies opcionales para mejorar tu experiencia en nuestros sitios web y mostrarte publicidad personalizada basada en tu actividad en l\xednea. Si rechazas las cookies opcionales, solo se utilizar\xe1n las cookies necesarias para prestarte los servicios indicados anteriormente. Para cambiar la selecci\xf3n de las cookies que deseas aceptar, haz clic en \u{201C}Administrar cookies\u{201D} en la parte inferior de la p\xe1gina. Esta selecci\xf3n se mantiene durante 180 d\xedas. Revisa tu selecci\xf3n con regularidad. <br/> <br/> <a href="${g}">C\xf3mo gestionar las preferencias de cookies</a> | <a href="${f}">Declaraci\xf3n de privacidad</a> | <a href="${h}">Cookies de terceros</a>.`,
                    ...
                    preferencesDialogDescHtml: `La mayor\xeda de los sitios web de GitHub utilizan cookies. Las cookies son peque\xf1os archivos de texto que se almacenan en tu dispositivo para que los servidores web puedan utilizarlos posteriormente. GitHub y nuestros socios terceros utilizan cookies para recordar tus preferencias y configuraci\xf3n, ayudarte a iniciar sesi\xf3n, mostrarte anuncios personalizados y analizar el funcionamiento de nuestros sitios web. Para obtener m\xe1s informaci\xf3n, consulta la secci\xf3n Cookies y tecnolog\xedas similares de la <a href="${f}">Declaraci\xf3n de privacidad</a>.`,
                    acceptLabel: "Aceptar",
        ...
        async function _(e) {
            let {
                ConsentControl: o
            } = await a.e(85825).then(a.t.bind(a, 495672, 23)), i = e.split("-")[0] || "en", r = D[i] ? D[i] : D.en;
            if (!r) throw Error(`No language config found for locale: ${e}`);
            return s = new o("ghcc", e, P, r.cookieCategories, r.consentControlOptions)
        }
        async function U() {
            (await O()).showPreferences(B() || {})
        }
        async function I() {
            (await O()).showBanner(k)
        }
        ...
        function V(e) {
            ...
            (0, d.TV)(A, o, R.toUTCString()), W.resolve(e)
        }
    ...
    444507(e, o, a) {
        ...
        function t(e, o, a = null, s = !1, i = "lax", r = !1) {
            let n = document.domain;
            if (null == n) throw Error("Unable to get document domain");
            n.endsWith(".github.com") && (n = "github.com");
            let c = "https:" === location.protocol ? "; secure" : "",
                l = a ? `; expires=${a}` : "";
            !1 === s && (n = `.${n}`);
            try {
                document.cookie = `${e}=${o}; path=/; domain=${n}${l}${c}; samesite=${i}${r?"; partitioned":""}`
            } catch {}
        }
        ...
        function n(e, o = !1) {
            ...
            let s = new Date(Date.now() - 1).toUTCString(),
                i = "https:" === location.protocol ? "; secure" : "",
                r = `; expires=${s}`;
            !1 === o && (a = `.${a}`);
            try {
                document.cookie = `${e}=''; path=/; domain=${a}${r}${i}`
            } catch {}
        }
        a.d(o, {
            OR: () => i,
...
//# sourceMappingURL=26194-4de6887bb62715e7-ec9a204336817ac5.js.map