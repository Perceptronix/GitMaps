    ...
    [7882], {
        ...
        34792: (e, t, r) => {
            ...
            function c() {
                return (c = (0, u.default)(o.default.mark(function e(t, r, n) {
                    var a, u, s, c, f, p, d, v, h, x = arguments;
                    return o.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return u = (a = x.length > 3 && void 0 !== x[3] ? x[3] : {}).ctx, c = void 0 === (s = a.req) ? null == u ? void 0 : u.req : s, f = "".concat(l(r), "/").concat(t), e.prev = 2, d = {
                                    headers: i({
                                        "Content-Type": "application/json"
                                    }, null != c && null != (p = c.headers) && p.cookie ? {
                                        cookie: c.headers.cookie
                                    } : {})
                                }, null != c && c.body && (d.body = JSON.stringify(c.body), d.method = "POST"), e.next = 7, fetch(f, d);
                            case 7:
            ...
            function l(e) {
                return "u" < typeof window ? "".concat(e.baseUrlServer).concat(e.basePathServer) : e.basePath
            }
        ...
        37882: (e, t, r) => {
            ...
            t.SessionContext = void 0, t.SessionProvider = function(e) {
                ...
                j._lastSync = f ? (0, _.now)() : 0;
                var d = x.useState(function() {
                        return f && (j._session = e.session), e.session
                    }),
                    y = (0, h.default)(d, 2),
                    b = y[0],
                    w = y[1],
                ...
                x.useEffect(function() {
                    return j._getSession = (0, v.default)(p.default.mark(function e() {
                            var t, r, n = arguments;
                            return p.default.wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        if (t = (n.length > 0 && void 0 !== n[0] ? n[0] : {}).event, e.prev = 1, !((r = "storage" === t) || void 0 === j._session)) {
                                            e.next = 10;
                                            break
                                        }
                                        return j._lastSync = (0, _.now)(), e.next = 7, R({
                                            broadcast: !r
                                        });
                                    case 7:
                                        return j._session = e.sent, w(j._session), e.abrupt("return");
                                    case 10:
                                        if (!(!t || null === j._session || (0, _.now)() < j._lastSync)) {
                                            e.next = 12;
                                            break
                                        }
                                        return e.abrupt("return");
                                    case 12:
                                        return j._lastSync = (0, _.now)(), e.next = 15, R();
                                    case 15:
                                        j._session = e.sent, w(j._session), e.next = 22;
                                        break;
                                    case 19:
                                        e.prev = 19, e.t0 = e.catch(1), P.error("CLIENT_SESSION_ERROR", e.t0);
                                    case 22:
                                        return e.prev = 22, E(!1), e.finish(22);
                                    case 25:
                                    case "end":
                                        return e.stop()
                                }
                ...
                var A = (t = x.useState("u" > typeof navigator && navigator.onLine), n = (r = (0, h.default)(t, 2))[0], o = r[1], a = function() {
                        return o(!0)
                    }, u = function() {
                        return o(!1)
                    }, x.useEffect(function() {
                ...
                var L = x.useMemo(function() {
                    return {
                        data: b,
                        status: S ? "loading" : b ? "authenticated" : "unauthenticated",
                        update: function(e) {
                            return (0, v.default)(p.default.mark(function t() {
                                var r;
                                return p.default.wrap(function(t) {
                                    for (;;) switch (t.prev = t.next) {
                                        ...
                                        case 2:
                                            return E(!0), t.t0 = _.fetchData, t.t1 = j, t.t2 = P, t.next = 8, T();
                                        case 8:
                                        ...
                                        case 15:
                                            return r = t.sent, E(!1), r && (w(r), k.post({
                                                event: "session",
                                                data: {
                                                    trigger: "getSession"
                                                }
            ...
            }, t.getCsrfToken = T, t.getProviders = L, t.getSession = R, t.signIn = function(e, t, r) {
                return N.apply(this, arguments)
            }, t.signOut = function(e) {
                return I.apply(this, arguments)
            }, t.useSession = function(e) {
                if (!M) throw Error("React Context is unavailable in Server Components");
                var t = x.useContext(M),
                    r = null != e ? e : {},
                    n = r.required,
            ...
            var j = {
                    baseUrl: (0, b.default)(null != (n = i.env.NEXTAUTH_URL) ? n : i.env.VERCEL_URL).origin,
                    basePath: (0, b.default)(i.env.NEXTAUTH_URL).path,
                    baseUrlServer: (0, b.default)(null != (o = null != (a = i.env.NEXTAUTH_URL_INTERNAL) ? a : i.env.NEXTAUTH_URL) ? o : i.env.VERCEL_URL).origin,
                    basePathServer: (0, b.default)(null != (u = i.env.NEXTAUTH_URL_INTERNAL) ? u : i.env.NEXTAUTH_URL).path,
                    _lastSync: 0,
                    _session: void 0,
                    _getSession: function() {}
                },
                k = (0, _.BroadcastChannel)(),
                P = (0, y.proxyLogger)(y.default, j.basePath),
                M = t.SessionContext = null == (s = x.createContext) ? void 0 : s.call(x, void 0);
            ...
            function A() {
                return (A = (0, v.default)(p.default.mark(function e(t) {
                    var r, n;
                    return p.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return e.next = 2, (0, _.fetchData)("session", j, P, t);
                            case 2:
                                return n = e.sent, (null == (r = null == t ? void 0 : t.broadcast) || r) && k.post({
                                    event: "session",
                                    data: {
                                        trigger: "getSession"
                                    }
            ...
            function U() {
                return (U = (0, v.default)(p.default.mark(function e(t) {
                    var r;
                    return p.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return e.next = 2, (0, _.fetchData)("csrf", j, P, t);
                            case 2:
            ...
            function C() {
                return (C = (0, v.default)(p.default.mark(function e() {
                    return p.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return e.next = 2, (0, _.fetchData)("providers", j, P);
                            case 2:
            ...
            function N() {
                return (N = (0, v.default)(p.default.mark(function e(t, r, n) {
                    var o, a, u, s, i, c, l, f, d, v, h, x, y, b, g, w, O;
                    return p.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return u = void 0 === (a = (o = null != r ? r : {}).callbackUrl) ? window.location.href : a, i = void 0 === (s = o.redirect) || s, c = (0, _.apiBaseUrl)(j), e.next = 4, L();
                            case 4:
                                if (l = e.sent) {
                                    e.next = 8;
                                    break
                            ...
                            case 11:
                                return f = "credentials" === l[t].type, d = "email" === l[t].type, v = f || d, h = "".concat(c, "/").concat(f ? "callback" : "signin", "/").concat(t), x = "".concat(h).concat(n ? "?".concat(new URLSearchParams(n)) : ""), e.t0 = fetch, e.t1 = x, e.t2 = {
                                    "Content-Type": "application/x-www-form-urlencoded"
                                }, e.t3 = URLSearchParams, e.t4 = E, e.t5 = E({}, r), e.t6 = {}, e.next = 25, T();
                            case 25:
                            ...
                            case 36:
                                ...
                                return w = null != (g = b.url) ? g : u, window.location.href = w, w.includes("#") && window.location.reload(), e.abrupt("return");
                            case 42:
                                if (O = new URL(b.url).searchParams.get("error"), !y.ok) {
                                    e.next = 46;
                                    break
                                }
                                return e.next = 46, j._getSession({
                                    event: "storage"
                                });
                            case 46:
                                return e.abrupt("return", {
            ...
            function I() {
                return (I = (0, v.default)(p.default.mark(function e(t) {
                    var r, n, o, a, u, s, i, c, l;
                    return p.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return o = void 0 === (n = (null != t ? t : {}).callbackUrl) ? window.location.href : n, a = (0, _.apiBaseUrl)(j), e.t0 = {
                                    "Content-Type": "application/x-www-form-urlencoded"
                                }, e.t1 = URLSearchParams, e.next = 6, T();
                            case 6:
                            ...
                            case 16:
                                ...
                                return l = null != (c = i.url) ? c : o, window.location.href = l, l.includes("#") && window.location.reload(), e.abrupt("return");
                            case 23:
                                return e.next = 25, j._getSession({
                                    event: "storage"
                                });
                            case 25:
        ...
        42282: e => {
            function t(r, n, o, a) {
                ...
                }, e.exports.__esModule = !0, e.exports.default = e.exports, t(r, n, o, a)
            }
        ...
        42980: (e, t, r) => {
            ...
            function c(e) {
                ...
                if (null != (t = e) && t.error) {
                    e.error = c(e.error), e.message = null != (r = e.message) ? r : e.error.message
                }
                return e
            }
            var l = {
        ...
        61061: (e, t, r) => {
                        ...
                        return o.default.wrap(function(r) {
                            for (;;) switch (r.prev = r.next) {
                                ...
                                case 6:
                                    return r.abrupt("return", r.sent);
                                case 9:
                                    throw r.prev = 9, r.t0 = r.catch(0), t.error("adapter_error_".concat(n), r.t0), (c = new v(r.t0)).name = "".concat(x(n), "Error"), c;
                                case 15:
                                case "end":
                                    return r.stop()
                            }
            ...
            }, t.capitalize = x, t.eventsErrorHandler = function(e, t) {
                        ...
                        return o.default.wrap(function(r) {
                            for (;;) switch (r.prev = r.next) {
                                ...
                                case 4:
                                    return r.abrupt("return", r.sent);
                                case 7:
                                    r.prev = 7, r.t0 = r.catch(0), t.error("".concat(h(n), "_EVENT_ERROR"), r.t0);
                                case 10:
                                case "end":
                                    return r.stop()
                            }
            ...
            function p(e, t, r) {
                return t = (0, l.default)(t), (0, c.default)(e, d() ? Reflect.construct(t, r || [], (0, l.default)(e).constructor) : t.apply(e, r))
            }
            ...
            var v = t.UnknownError = function(e) {
                function t(e) {
                    var r, n;
                    return (0, s.default)(this, t), (n = p(this, t, [null != (r = null == e ? void 0 : e.message) ? r : e])).name = "UnknownError", n.code = e.code, e instanceof Error && (n.stack = e.stack), n
                }
            ...
            t.OAuthCallbackError = function(e) {
                ...
                return (0, f.default)(t, e), (0, i.default)(t)
            }(v), t.AccountNotLinkedError = function(e) {
                function t() {
                    var e;
                    (0, s.default)(this, t);
                    for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
                ...
                return (0, f.default)(t, e), (0, i.default)(t)
            }(v), t.MissingAPIRoute = function(e) {
                function t() {
                    var e;
                    (0, s.default)(this, t);
                    for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
                ...
                return (0, f.default)(t, e), (0, i.default)(t)
            }(v), t.MissingAuthorize = function(e) {
                function t() {
                    var e;
                    (0, s.default)(this, t);
                    for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
                ...
                return (0, f.default)(t, e), (0, i.default)(t)
            }(v), t.MissingAdapterMethods = function(e) {
                function t() {
                    var e;
                    (0, s.default)(this, t);
                    for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
                ...
                return (0, f.default)(t, e), (0, i.default)(t)
            }(v), t.UnsupportedStrategy = function(e) {
                function t() {
                    var e;
                    (0, s.default)(this, t);
                    for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
                ...
                return (0, f.default)(t, e), (0, i.default)(t)
            }(v), t.InvalidCallbackUrl = function(e) {
                function t() {
                    var e;
                    (0, s.default)(this, t);
                    for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
        ...
        83747: (e, t, r) => {
            var n = r(88261),
                o = r(33945);
            e.exports = function(e, t, r, a, u) {
                return new o(n().w(e, t, r, a), u || Promise)
            }, e.exports.__esModule = !0, e.exports.default = e.exports
        },
        84447: (e, t, r) => {
            var n = r(82848).default;
                    ...
                    return function(n) {
                        t || (t = {
                            ...
                            delegateYield: function(e, o, a) {
                                return t.resultName = o, r(n.d, c(e), a)
                            },
                            finish: function(e) {
                                return r(n.f, e)
                            }
        ...
        88261: (e, t, r) => {
            ...
            function o() {
                ...
                function i(e, o, a, u) {
                    var s = Object.create((o && o.prototype instanceof l ? o : l).prototype);
                    return n(s, "_invoke", function(e, n, o) {
                        var a, u, s, i = 0,
                            l = o || [],
                            f = !1,
                            p = {
                                ...
                                f: d.bind(t, 4),
                                d: function(e, r) {
                                    return a = e, u = 0, s = t, p.n = r, c
                                }
                            };

                        function d(e, n) {
                            for (u = e, s = n, r = 0; !f && i && !o && r < l.length; r++) {
                                var o, a = l[r],
                                    d = p.p,
                                    v = a[2];
                                e > 3 ? (o = v === n) && (s = a[(u = a[4]) ? 5 : (u = 3, 3)], a[4] = a[5] = t) : a[0] <= d && ((o = e < 2 && d < a[1]) ? (u = 0, p.v = n, p.n = a[1]) : d < v && (o = e < 3 || a[0] > n || n > v) && (a[4] = e, a[5] = n, p.n = v, u = 0))
                            }
                            if (o || e > 1) return c;
                            throw f = !0, n
                        }
                        return function(o, l, v) {
                            ...
                            for (f && 1 === l && d(l, v), u = l, s = v;
                                (r = u < 2 ? t : s) || !f;) {
                                a || (u ? u < 3 ? (u > 1 && (p.n = -1), d(u, s)) : p.n = s : p.v = s);
                                try {
                                    if (i = 2, a) {
                                        if (u || (o = "next"), r = a[o]) {
                                            ...
                                            if (!r.done) return r;
                                            s = r.value, u < 2 && (u = 0)
                                        } else 1 === u && (r = a.return) && r.call(a), u < 2 && (s = TypeError("The iterator does not provide a '" + o + "' method"), u = 1);
                                        a = t
                                    } else if ((r = (f = p.n < 0) ? s : e.call(n, p)) !== c) break
                                } catch (e) {
                                    a = t, u = 1, s = e
                                } finally {
                                    i = 1
                ...
                var d = p.prototype = l.prototype = Object.create([][u] ? r(r([][u]())) : (n(r = {}, u, function() {
                    return this
                }), r));

                function v(e) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(e, p) : (e.__proto__ = p, n(e, s, "GeneratorFunction")), e.prototype = Object.create(d), e
                }
                return f.prototype = p, n(d, "constructor", p), n(p, "constructor", f), f.displayName = "GeneratorFunction", n(p, s, "GeneratorFunction"), n(d), n(d, s, "Generator"), n(d, u, function() {
                    return this
